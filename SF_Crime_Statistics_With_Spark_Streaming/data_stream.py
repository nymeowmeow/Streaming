...
def run_spark_job(spark):
    ...
    df = spark \
        ...
        .option('subscribe', 'com.udacity.streaming.department.police.calls') \
    ...
    join_query = agg_df. \
                join(broadcast(radio_code_df), col('agg_df.disposition') == col('radio_code_df.disposition'), 'left_outer')
